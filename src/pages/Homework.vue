		...
		<div style="padding: 0.2rem 0rem">
			...
			<div class="displayflex mtop20">
                ...
                <div class="relative mleft10 flex-start">
                    ...
                    :on-change="(file)=>{return handleChange(file, 22)}"
                    :auto-upload="true">
                        <el-button class="select-file" slot="trigger" size="small" type="primary"><div class="upload-text">{{uploadText}}</div></el-button>
                        <div slot="tip" class="el-upload__tip">只能上传mp4文件，且不超过100MB</div>
                    </el-upload>
                    <!-- <el-button class="up-button" size="small" type="success" @click="submitUpload">开始上传</el-button> -->
                </div>
...
export default {
  ...
  methods: {
    ...
    beforeAvatarUpload(file) {
      ...
      const extension =
        fileArr[fileLength - 1] === "mp4" || file.name.indexOf("mov") > -1;
